...
(function (window) {
    ...
    KDNAGradient.prototype.init = function (canvas) {
        ...
        self._onResize = function () {
            ...
            var ny = Math.min(400, Math.max(12, Math.ceil(nph * self.densityMul)));
    ...
    KDNAGradient.prototype._initRefraction = function (cfg, pw, ph) {
        ...
        self.refractActive = ( type === 'liquid' || type === 'fluted' || type === 'diamond' ) && strength > 0;
        if (!self.refractActive) return;

        var gl = self.minigl.gl;
        self._glTypeNum = type === 'liquid' ? 1 : ( type === 'fluted' ? 2 : 3 );
