...
(function (window) {
    ...
    KDNAGradient.prototype.init = function (canvas) {
        ...
        /* Concentric dynamics: colours blend through a smooth radial gradient
           that scrolls outward at Radiate Speed (0 = still); Ring Count sets
           how many colour cycles span the shape. Speed maps to a slow, smooth
           range in the shader so it never looks frantic. */
