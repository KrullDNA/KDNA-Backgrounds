(function ($) {
    ...
    function buildConfigFromDOM() {
        ...
        return {
            ...
            diamondAngle:    numVal('#kdna_bg_diamond_angle', 45),
            lightMove:       numVal('#kdna_bg_light_move', 30),
            ribSharp:        numVal('#kdna_bg_rib_sharp', 0),
            bevelWidth:      numVal('#kdna_bg_bevel_width', 50),
    ...
    $(function () {
        ...
        $('input[type="range"]').on('input', function () {
            var valMap = {
                ...
                'kdna_bg_diamond_angle': '#kdna-bg-diamond-angle-val',
                'kdna_bg_light_move': '#kdna-bg-light-move-val',
                'kdna_bg_rib_sharp': '#kdna-bg-rib-sharp-val',
                'kdna_bg_bevel_width': '#kdna-bg-bevel-width-val',
